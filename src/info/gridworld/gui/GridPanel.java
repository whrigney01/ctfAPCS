        ...
        PseudoInfiniteViewport.Pannable
{
    ...
    private Color backgroundColor = new Color (140, 191, 139);  // default Color.WHITE
    ...
    private void drawMidline(Graphics2D g2){
        Insets insets = getInsets();
        g2.setColor(new Color (64, 64, 64));
        g2.fillRect(insets.left+(numCols*(cellSize + 1) + 1)/2 - 4, insets.top, 8, numRows
                * (cellSize + 1) + 1);
