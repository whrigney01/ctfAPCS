...
public class PenguinMomentTeam extends Team {
	...
	public PenguinMomentTeam() {
		...
		//super.addPlayer(new LurePlayer(new Location(10, 49)));
		super.addPlayer(new OffensePlayer(new Location(11, 49), -1));
		super.addPlayer(new OffensePlayer(new Location(10, 49), -1));
		super.addPlayer(new OffensePlayer(new Location(45, 49), 1));
		super.addPlayer(new OffensePlayer(new Location(46, 49), 1));
	}
